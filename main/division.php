...
<body>
  ...
  <div class="content">
    ...
    <div class="searchtab">
      <?php
      $sql = "SELECT d.ID AS 'DIVISION ID', d.NAME AS 'DIVISION NAME', e.NAME AS 'HEAD NAME' FROM division as d JOIN employee as e ON d.HEAD = e.ID";
      ...
      <a href="../add/div.php"><button class="btn" id="add">เพิ่มข้อมูล</button></a>
    </div>
    ...
    <table>
      ...
      <?php foreach ($rows as $row) : ?>
        <tr>
          <td><?php echo $row['DIVISION ID'] ?></td>
